    ...
    return (
        <div
            ...
            <section className='absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2'>
                <div class="w-full p-4 md:p-10 border border-green-600 rounded-xl bg-green-50">
                    <button
                    ...
                    <div class="mb-6 max-w-[450px] lg:mb-0">
                        <h2
                            class="text-dark mb-4 text-[32px] font-bold uppercase sm:text-[40px] lg:text-[36px] xl:text-[40px]"
                        >
                        ...
                        <div class="mb-4 flex w-full max-w-[370px]">
                            ...
                            <div class="w-full">
                                ...
                                <p class="text-body-color text-base">+91 8077117709</p>
                            </div>
                        </div>
                        <div class="mb-4 flex w-full max-w-[370px]">
                            <div
                            ...
                            <div class="w-full">
                                ...
                                <p class="text-body-color text-base">harshgolu82@gmail.com</p>
                            </div>
                        </div>
                    </div>
                </div>
