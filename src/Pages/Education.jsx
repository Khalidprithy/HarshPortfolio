...
const Education = () => {
    return (
        <div id='education' className='font-mono max-w-screen-xl mx-auto'>
            <h3 className='text-4xl text-center p-4'>Educations</h3>
            <div className='bg-teal-50 rounded-xl p-4 mb-4 shadow-md'>
                <div className='flex items-center justify-between'>
                    <div>
                        <h4 className='text-xl font-semibold text-yellow-500'>University of XYZ</h4>
                        <h6 className='text-lg font-medium text-red-400'>Bachelor of Science in Computer Science</h6>
                    </div>
